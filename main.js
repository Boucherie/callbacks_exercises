...
function purchases(transactions) {
  return transactions.type === 'purchase';
};
...
function cashSales(transactions) {
  return transactions.type === 'sale' && transactions.paymentMethod === 'cash';
};
...
*/
function creditPurchases(transactions) {
  return transactions.type === 'purchase' && transactions.paymentMethod === 'credit';
};
...
function getVendor(transactions) {
...
var uniqueVendors = transactions.filter(getVendor).map(getVendor).filter(removeDuplicates);
